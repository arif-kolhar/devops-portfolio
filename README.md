...
I am Rohit Kumar Vishwakarma, a DevOps Engineer passionate about integrating technologies and enhancing the DevOps journey. As the founder of HelpOps-Hub, I created a platform to share solutions and prevent others from struggling with DevOps errors. I specialize in Linux, Kubernetes, AWS, Docker, Jenkins, and more, constantly seeking to upskill and innovate in the DevOps industry.
...
- **CI/CD Tools**: Jenkins, GitHub Actions, ArgoCD, CircleCI, AWS Pipeline
- **Containerization Tools**: Docker, Docker Hub, Kubernetes
- **Service Mesh & Microservices**: Istio
- **Monitoring and Logging Tools**: Grafana, Prometheus, Nginx, ELK
...
### [Project 1: Deploying Netflix Clone with DevSecOps](https://github.com/Rohitz999/DevSecOps-CICD-Pipeline-NetflixClone)
...
### [Project 2: Automated CI/CD Pipeline with Docker and Jenkins-SpaceWeb](https://github.com/Rohitz999/Automated-CI-CD-Pipeline-Space-Web)
...
### [Project 3: Deploying Spring Boot Java App with GitOps](https://github.com/Rohitz999/maven-jenkins-ArgoCD)
...
### [Project 4: Azure WebApp Github Actions](https://github.com/Rohitz999/Azure-WebApp-Github-Actions)
...
### [Project 5: Deploying Three Tier App with Docker and Docker-compose](https://github.com/Rohitz999/three-tier-deploy-wanderlustApp)
...
- 💰 Become [Sponsor](https://github.com/sponsors/Rohitz999)!
- ⭐ Star our [Repo](https://github.com/Rohitz999/RohitOps)
>>>>>>> 8de809a (Initial commit)
